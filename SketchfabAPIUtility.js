...
function SketchfabAPIUtility(urlIDRef, iframeRef, callbackRef, clientInitObjectRef) {
    ...
    this.api;
    this.client;
    this.clientInitObject = {  internal: 1, ui_infos: 0, ui_controls: 0, watermark: 1, continuous_render: 1, supersample: 0 };//These are the default init properies , you can change these if you like. The success and error properties defaults are set later , they should NOT be altered 
